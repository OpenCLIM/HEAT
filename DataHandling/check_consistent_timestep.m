function [varout1,timesout1,varout2,timesout2] = check_consistent_timestep(varin1,timesin1,varin2,timesin2)
% [varout1,timesout1,varout2,timesout2] = ...
%     check_consistent_timestep(varin1,timesin1,varin2,timesin2)
%
...
if length(varin1(1,1,:)) ~= length(varin2(1,1,:))
