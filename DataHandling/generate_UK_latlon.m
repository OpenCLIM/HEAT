...
save('PreProcessedData/long_UK_CPM.mat','long_UK_CPM')
save('PreProcessedData/lat_UK_CPM.mat','lat_UK_CPM')
save('PreProcessedData/long_UK_RCM.mat','long_UK_RCM')
save('PreProcessedData/lat_UK_RCM.mat','lat_UK_RCM')
save('PreProcessedData/long_UK_GCM.mat','long_UK_GCM')
save('PreProcessedData/lat_UK_GCM.mat','lat_UK_GCM')
...
% them too:
long_UK_HadUK1 = ncread([HadUKdatadir,'1km/tas_hadukgrid_uk_1km_mon_198101-198112.nc'],'longitude');
lat_UK_HadUK1 = ncread([HadUKdatadir,'1km/tas_hadukgrid_uk_1km_mon_198101-198112.nc'],'latitude');

long_UK_HadUK12 = ncread([HadUKdatadir,'12km/tas_hadukgrid_uk_12km_mon_198101-198112.nc'],'longitude');
lat_UK_HadUK12 = ncread([HadUKdatadir,'12km/tas_hadukgrid_uk_12km_mon_198101-198112.nc'],'latitude');

long_UK_HadUK60 = ncread([HadUKdatadir,'60km/tas_hadukgrid_uk_60km_mon_188401-188412.nc'],'longitude');
lat_UK_HadUK60 = ncread([HadUKdatadir,'60km/tas_hadukgrid_uk_60km_mon_188401-188412.nc'],'latitude');

% Testing difference between method of converting BNG to lat-long
x_UK_HadUK12 = ncread([HadUKdatadir,'12km/tas_hadukgrid_uk_12km_mon_198101-198112.nc'],'projection_x_coordinate');
y_UK_HadUK12 = ncread([HadUKdatadir,'12km/tas_hadukgrid_uk_12km_mon_198101-198112.nc'],'projection_y_coordinate');

x_UK_HadUK60 = ncread([HadUKdatadir,'60km/tas_hadukgrid_uk_60km_mon_188401-188412.nc'],'projection_x_coordinate');
y_UK_HadUK60 = ncread([HadUKdatadir,'60km/tas_hadukgrid_uk_60km_mon_188401-188412.nc'],'projection_y_coordinate');
...
clear curdir HadUKdatadir ncdatadir1 ncdatadir2
