...
inputs.ExptName = 'ARCADIA-Tmax-BC-past_v2'; % Give the experiment a name (no spaces)
...
inputs.Scenario = {'past'}; % 'past', '1.5','2.0','3.0','4.0'
inputs.AnnSummer = 'Ann'; % OR inputs.AnnSummer = 'Summer'; 'JJA'; 'MJJAS','ann'; % Summer = 1st June-15th Sept. or leave blank for annual mean
