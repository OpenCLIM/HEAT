...
inputs.ExptName = 'CPM_MMM_test'; % Give the experiment a name (no spaces)
...
inputs.Variable = {'sWBGTmax'}; % prefixes: 'T', 'VP', 'sWBGT', 'HD', 'AT', 'THI'; suffixes: 'max', 'min' or nothing for daily mean
inputs.Dataset = {'CPM-01'};
